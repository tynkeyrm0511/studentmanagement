...
@section('content')
    ...
    <div class="container mx-auto mt-25">
        <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
            <h2 class="text-lg font-semibold text-gray-700 capitalize dark:text-white">Class Edit</h2>
            ...
            <form action="{{ route('classes.update', $classes->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    <div>
                        ...
                        <input value="{{ $classes->name }}" type="text" placeholder="Enter your class name" id="name" name="name"
