            ...
            <form action="{{ URL('students/update', $students->id) }}" method="POST">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                    <div>
                        ...
                        <input value="{{ $students->name }}" type="text" placeholder="Enter your name" id="name" name="name"
                    ...
                    <div>
                        ...
                        <input value="{{ $students->dob }}" type="date" placeholder="Syntax Ngo" id="dob" name="dob"
                            class="block  mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
                    </div>
                    ...
                    <div>
                        ...
                        <input value="{{ $students->email }}" type="email" placeholder="SyntaxNgo@example.com" id="email" name="email"
                    ...
                    <div>
                        ...
                        <input value="{{ $students->phone }}" type="text" placeholder="Enter your phone number" id="phone" name="phone"
                            class="block  mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-gray-700 focus:border-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300" />
                    </div>
